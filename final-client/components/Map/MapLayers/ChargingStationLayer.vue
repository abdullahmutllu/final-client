  ...
  >
    <div v-if="selectedFeature" class="grid grid-cols-2 gap-4">
      <div>
        ...
        <p>
          <strong>İlçe:</strong> {{ selectedFeature.district || 'Bilinmiyor' }}
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          <strong>Voltaj:</strong> {{ selectedFeature.voltage || 'Bilinmiyor' }}
        </p>
        <p>
          <strong>Amper:</strong> {{ selectedFeature.amperage || 'Bilinmiyor' }}
        </p>
        <p>
...
import markerIcon from '@/assets/chargingStation.png'
